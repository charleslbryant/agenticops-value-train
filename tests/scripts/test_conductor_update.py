...
class TestUpdateSessionPhase:
    ...
    def test_update_session_phase_success(self, temp_project_root, sample_active_session):
...
"""
        ...
        result = update_session_phase(temp_project_root, sample_active_session, sections, "discovery", next_phase_info)
...
"""
        ...
        result = update_session_phase(temp_project_root, content, sections, "discovery", next_phase_info)
...
class TestMainFunction:
    ...
    def test_main_successful_advancement(self, temp_project_root, sample_pipeline_config, sample_active_session):
        ...
        with patch('sys.argv', ['conductor_update.py', '--project-root', str(temp_project_root)]):
    ...
    def test_main_dry_run_mode(self, temp_project_root, sample_pipeline_config, sample_active_session):
        """Test dry run mode."""
        # Setup test files
        from tests.conftest import create_test_files
        create_test_files(temp_project_root, sample_pipeline_config, sample_active_session)
        ...
        with patch('sys.argv', ['conductor_update.py', '--project-root', str(temp_project_root), '--dry-run']):
            with patch('sys.exit') as mock_exit:
                main()
                mock_exit.assert_not_called()
    ...
    def test_main_force_phase(self, temp_project_root, sample_pipeline_config, sample_active_session):
        """Test forcing advance to specific phase."""
        # Setup test files
        from tests.conftest import create_test_files
        create_test_files(temp_project_root, sample_pipeline_config, sample_active_session)
        
        with patch('sys.argv', ['conductor_update.py', '--project-root', str(temp_project_root), '--force-phase', 'scope']):
            with patch('sys.exit') as mock_exit:
                main()
                mock_exit.assert_not_called()
    ...
    def test_main_at_end_of_pipeline(self, temp_project_root, sample_pipeline_config):
        ...
        session_content = sample_active_session.replace('phase: "enablement"', 'phase: "scope"')
...
"""
    ...
    def test_main_missing_current_phase(self, temp_project_root, sample_pipeline_config):
...
"""
    ...
    def test_main_invalid_force_phase(self, temp_project_root, sample_pipeline_config, sample_active_session):
        """Test forcing advance to invalid phase."""
        from tests.conftest import create_test_files
        create_test_files(temp_project_root, sample_pipeline_config, sample_active_session)
        
        with patch('sys.argv', ['conductor_update.py', '--project-root', str(temp_project_root), '--force-phase', 'nonexistent']):
            with pytest.raises(SystemExit) as exc_info:
                main()
...
class TestErrorHandling:
    ...
    def test_yaml_parsing_error_handling(self, temp_project_root, sample_pipeline_config):
